# Generated by Django 2.2.17 on 2020-11-30 09:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("user_or_investor", models.BooleanField(default=False)),
                ("type_company", models.CharField(max_length=20)),
                (
                    "groups",
                ...
                ("list_no", models.ManyToManyField(related_name="list_no", to="infotinder.Startapp")),
                ("list_yes", models.ManyToManyField(related_name="list_yes", to="infotinder.Startapp")),
                (
                    "user_permissions",
                    models.ManyToManyField(
                        blank=True,
